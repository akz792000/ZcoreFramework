...
public class UserDetailsAuthenticationToken extends AbstractAuthenticationToken {
	...
	public UserDetailsAuthenticationToken(Object principal) {
		super(null);
		this.principal = principal;
		setAuthenticated(false);
	}
	
	public UserDetailsAuthenticationToken(Object principal, Collection<? extends GrantedAuthority> authorities) {
		super(authorities);
		this.principal = principal;
