...
@Component
public class SecondNormalPartitioner extends DefaultPartitioner {

    private static final Log LOGGER = LogFactory.getLog(SecondNormalPartitioner.class);
    ...
    protected AggregationInfo getAggregationInfo() throws Exception {
        LOGGER.info("SecondNormalPartitioner.getAggregationInfo() is called.");
        return new AggregationInfo(1L, 19L, 20L);
    }

    @Override
    protected void logError(int gridSize, Throwable e) throws Exception {
        LOGGER.error("Unexpected method call of SecondNormalPartitioner.logError()!");
