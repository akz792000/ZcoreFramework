...
@Component
public class TransactionalPartitioner extends DefaultPartitioner {
    ...
    protected AggregationInfo getAggregationInfo() throws Exception {
        ...
        return new AggregationInfo(10L, 1112L, 800L);
    }

    @Override
    protected void logError(int gridSize, Throwable e) throws Exception {
        repository.persist(new StudentEntity(2L, "Partitioner.logError()", "Is Committed", 32));
    }
}
