...
@Component
public class HighConcurrentPartitioner extends DefaultPartitioner {

    private static final Log LOGGER = LogFactory.getLog(HighConcurrentPartitioner.class);
    ...
    protected AggregationInfo getAggregationInfo() throws Exception {
        ...
        return new AggregationInfo(1L, 800L, 800L);
    }
