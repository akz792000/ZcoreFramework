...
@Scope("step")
@Component
public class NormalLogErrorDefaultPartitionedItemReader extends DefaultPartitionedItemReader<StudentEntity, StudentEntity> {

    private static final Log LOGGER = LogFactory.getLog(NormalLogErrorDefaultPartitionedItemReader.class);

    @RepositoryInstance
    private DefaultRepository repository;

    public NormalLogErrorDefaultPartitionedItemReader() {
        super(null);
    }
