 ...
 */
@Entity
@Table(name = TestBatchEntity.TABLE_NAME, schema = Schema.ZC)
@NamedQueries({
        @NamedQuery(name = "TestBatchEntity.loadByOrg", query = "select e from TestBatchEntity e where e.orgId= :value  ")
})
public class TestBatchEntity implements Serializable {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME = "TST_BATCH";
