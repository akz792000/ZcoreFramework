...
@Component
public class ZeroCountPartitioner extends DefaultPartitioner {

    private static final Log LOGGER = LogFactory.getLog(ZeroCountPartitioner.class);
    ...
    protected AggregationInfo getAggregationInfo() throws Exception {
        ...
        return new AggregationInfo(10L, 1112L, 0L);
    }
