...
@Component
public class LowCountPartitioner extends DefaultPartitioner {

    private static final Log LOGGER = LogFactory.getLog(LowCountPartitioner.class);
    ...
    protected AggregationInfo getAggregationInfo() throws Exception {
        ...
        return new AggregationInfo(10L, 1112L, 3L);
    }
