...
import org.zcoreframework.validation.core.BeanValidatorImpl;
...
public class AnnotationConfigDefinitionParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        BeanDefinitionBuilder providerManagerBldr = BeanDefinitionBuilder.rootBeanDefinition(BeanValidatorImpl.class);
