        ...
        $.jstree.plugin("core", {
            ...
            _fn: {
                init: function () {
                    ...
                    // <AZADI> Azadi Search
                    if (this.get_settings().searchShow != undefined && this.get_settings().searchShow.show == true)
                        this.get_container().prepend("<div > <input id='searchInput' class='zui-text-rtl ui-widget-content ui-corner-all  zui-text-sizing  zui-text zui-tree_search'    />  </div>");
                    this.get_container().append(" <ul><li class='jstree-last jstree-leaf'><ins>&#160;</ins><a class='jstree-loading' href='#'><ins class='jstree-icon'>&#160;</ins>" + this._get_string("loading") + "</a></li></ul>");
                    // <AZADI> end Azadi Search
                    this.data.core.li_height = this.get_container_ul().find("li.jstree-closed, li.jstree-leaf").eq(0).height() || 18;
                    // Azadi Get CurrentThis
                    var currentThis = this
                    this.get_container()
                        .delegate("li > ins", "click.jstree", $.proxy(function (event) {
                            //<ZANDI>
                            if (this.get_container().attr('disabled')) return false;
                            //</ZANDI>
                        ...
                        .delegate("#searchInput", "change.jstree", function (e) {
                            currentThis.refresh(-1);
                            // currentThis.search($('#searchInput').val(),false);
                        });
                    //Azadi add Bind With proxy today end
                ...
                refresh: function (obj) {
                    ...
                    //<ZANDI>
                    //  <AZADI>Todo Azadi Search
                    if (this.get_settings().searchShow != undefined && this.get_settings().searchShow.show == true) {
                        var searchValue = this.get_container().find("#searchInput").val();
                        this.get_container().html("<div > <input id='searchInput' class='zui-text-rtl ui-widget-content ui-corner-all  zui-text-sizing  zui-text zui-tree_search' type='text'    ></input> </div> <ul><li class='jstree-last jstree-leaf'><ins>&#160;</ins><a class='jstree-loading' href='#'><ins class='jstree-icon'>&#160;</ins>" + this._get_string("loading") + "</a></li></ul>");
                        this.get_container().find("#searchInput").val(searchValue);
                    }
                    else
                        this.get_container().html(" <ul><li class='jstree-last jstree-leaf'><ins>&#160;</ins><a class='jstree-loading' href='#'><ins class='jstree-icon'>&#160;</ins>" + this._get_string("loading") + "</a></li></ul>");
                    // <AZADI>  end Todo Azadi Search
                    //this.get_container().html("<ul><li class='jstree-last jstree-leaf'><ins>&#160;</ins><a class='jstree-loading' href='#'><ins class='jstree-icon'>&#160;</ins>" + this._get_string("loading") + "</a></li></ul>");
        ...
        $.jstree.plugin("ui", {
            __init: function () {
                ...
                this.get_container()
                    .delegate("a", "click.jstree", $.proxy(function (event) {
                        ...
                        if (!$(event.currentTarget).hasClass("jstree-loading") && !this.get_container().attr('disabled') /*<ZANDI/>*/) {
                    ...
                    .bind("move_node.jstree", $.proxy(function (event, data) {
                        if (data.rslt.cy) {
                            var _clicked = data.rslt.oc.find("a.jstree-clicked");
                            _clicked.removeClass("jstree-clicked ui-state-highlight");
                            if (!_clicked.hasClass('ui-state-active')) {
                                _clicked.removeClass('ui-corner-all');
                            }
                        }
                    }, this));
            },
            ...
            _fn: {
                ...
                hover_node: function (obj) {
                    ...
                    this.data.ui.hovered = obj.children("a").addClass("jstree-hovered ui-state-active ui-corner-all").parent();
                ...
                dehover_node: function () {
                    ...
                    p = a.removeClass("jstree-hovered ui-state-active").parent();
                ...
                select_node: function (obj, check, e) {
                    ...
                    if (proceed && !is_selected) {
                    	if (s.selecting_node !== undefined && s.selecting_node != "" && obj.attr("rel") != s.selecting_node) {
                    		 return;
                    	}
                        if (!is_range) {
                            this.data.ui.last_selected = obj;
                        }
                        obj.children("a").addClass("jstree-clicked ui-state-highlight ui-corner-all");
                ...
                deselect_node: function (obj) {
                    ...
                    if (this.is_selected(obj)) {
                        var a = obj.children("a");
                        a.removeClass("jstree-clicked ui-state-highlight");
                ...
                deselect_all: function (context) {
                    ...
                    var _clicked = ret.children("a.jstree-clicked");
                    _clicked.removeClass("jstree-clicked ui-state-highlight");
                    if (!_clicked.hasClass('ui-state-active')) {
                        _clicked.removeClass('ui-corner-all');
                    }
            ...
            __init: function () {
                ...
                $.each(this._get_settings().hotkeys, function (i, v) {
                    if (v !== false && $.inArray(i, bound) == -1) {
                        $(document).bind("keydown.jstree", i, function (event) {
                            return exec(i, event);
                        });
                        bound.push(i);
                    }
                        ...
                        case (!s.data && !!s.ajax) || (!!s.data && !!s.ajax && obj && obj !== -1):
                            ...
                            success_func = function (d, t, x) {
                                ...
                                if (d) {
                                    ...
                                    if (obj === -1 || !obj) {
                                        // AZADI SEARCH
                                        d.find("li.jstree-search").closest("ul").parent().removeClass("jstree-closed").addClass("jstree-open");
                                        this.get_container().children("ul").empty().append(d.children());
                                    }
                                    else {
                                        obj.append(d).children("a.jstree-loading").removeClass("jstree-loading");
                            ...
                            s.ajax.context = this;
                            //<ZANDI>
                            // according to handle with ajaxSetup error handling that set in zcore app
    ...
    (function ($) {
        ...
        $.vakata.dnd = {
            ...
            drag_start: function (e, data, html) {
                ...
                $(document).bind("mousemove.jstree", $.vakata.dnd.drag);
                $(document).bind("mouseup.jstree", $.vakata.dnd.drag_stop);
                return false;
            },
            drag: function (e) {
            ...
            drag_stop: function (e) {
                ...
                $(document).unbind("mousemove.jstree", $.vakata.dnd.drag);
                $(document).unbind("mouseup.jstree", $.vakata.dnd.drag_stop);
    ...
    (function ($) {
        $.jstree.plugin("checkbox", {
            ...
            _fn: {
                ...
                change_state: function (obj, state, zState /*<ZANDI/>*/) {
                    obj = this._get_node(obj);
                    ...
                    if (this._get_settings().checkbox.two_state) {
                        if (state) {
                            ...
                            //<ZANDI>
                            if (this._get_settings().checkbox.one_select && this.get_container().find(".jstree-checked").length) {
                                return false;
                            }
                            //</ZANDI>
                        ...
                        obj.parentsUntil(".jstree", "li").each(function () {
                            ...
                            if (state) {
                                ...
                                if ($this.children("ul").children("li.jstree-unchecked, li.jstree-undetermined").length) {
                                    ...
                                    //when check all child don't check parent
                ...
                check_node: function (obj) {
                    if (this.change_state(obj, false, true/*<ZANDI/>*/)) {
                        obj = this._get_node(obj);
                ...
                uncheck_node: function (obj) {
                    if (this.change_state(obj, true, true/*<ZANDI/>*/)) {
                ...
                check_all: function () {
                    ...
                    coll.each(function () {
                        _this.change_state(this, false, true/*<ZANDI/>*/);
                    });
                    this.__callback();
                },
                uncheck_all: function () {
                    var _this = this,
                        coll = this._get_settings().checkbox.two_state ? this.get_container_ul().find("li") : this.get_container_ul().children("li");
                    coll.each(function () {
                        _this.change_state(this, true, true/*<ZANDI/>*/);
                    });
                    this.__callback();
                },
    ...
    (function ($) {
        $.vakata.context = {
            ...
            show: function (s, t, x, y, d, p, rtl) {
                ...
                //<zandi>
                if ($.vakata.context.rtl) {
                    x = x - (w + 5) + p.context.offsetWidth;
                    if (x < 0) {
                        x = 0;
                    } else {
                ...
                $.vakata.context.cnt
                    //<zandi>
                    .attr('dir', $.vakata.context.rtl ? 'rtl' : 'lrt')
                    //</zandi>
                    .css({"left": x, "top": y})
                    .find("li:has(ul)")
            ...
            parse: function (s, is_callback) {
                ...
                $.each(s, function (i, val) {
                    ...
                    was_sep = false;
                    str += "<li class='ui-state-default ui-corner-all " + (val._class || "") + (val._disabled ? " jstree-contextmenu-disabled " : "") + "'><ins ";
        ...
        $(function () {
            ...
            $.vakata.context.cnt
                ...
                .appendTo("body");
            $(document).bind("mousedown.jstree", function (e) {
            ...
            if (typeof $.hotkeys !== "undefined") {
                $(document)
                    .bind("keydown.jstree", "up", function (e) {
                    ...
                    .bind("keydown.jstree", "down", function (e) {
                        if ($.vakata.context.vis) {
                    ...
                    .bind("keydown.jstree", "right", function (e) {
                        if ($.vakata.context.vis) {
                    ...
                    .bind("keydown.jstree", "left", function (e) {
                        if ($.vakata.context.vis) {
                    ...
                    .bind("keydown.jstree", "esc", function (e) {
                        $.vakata.context.hide();
                        e.preventDefault();
                    })
                    .bind("keydown.jstree", "space", function (e) {
        ...
        $.jstree.plugin("contextmenu", {
            __init: function () {
                this.get_container()
                    .delegate("a", "contextmenu.jstree", $.proxy(function (e) {
                        e.preventDefault();
                        if (!$(e.currentTarget).hasClass("jstree-loading") && !this.get_container().attr('disabled') /*<ZANDI/>*/) {
            ...
            _fn: {
                show_contextmenu: function (obj, x, y) {
                    ...
                    if (this.data.themes) {
                        $.vakata.context.cnt.attr("class", "jstree-" + this.data.themes.theme + "-context ui-widget ui-widget-content ui-corner-all ui-helper-clearfix");
                    }
                }
            }
        });
            ...
            __init: function () {
                ...
                this.get_container()
                    ...
                    .bind("deselect_all.jstree", $.proxy(function (e, data) {
                        var _clicked = this.get_container().find(" > .jstree-wholerow .jstree-clicked");
                        _clicked.removeClass("jstree-clicked ui-state-highlight " + (this.data.themeroller ? this._get_settings().themeroller.item_a : "" ));
                        if (!_clicked.hasClass('ui-state-active')) {
                            _clicked.removeClass('ui-corner-all');
                        }
                    }, this))
                    ...
                    .bind("hover_node.jstree dehover_node.jstree", $.proxy(function (e, data) {
                        var _hovered = this.get_container().find(" > .jstree-wholerow .jstree-hovered");
                        _hovered.removeClass("jstree-hovered ui-state-active " + (this.data.themeroller ? this._get_settings().themeroller.item_h : "" ));
                        if (!_hovered.hasClass('ui-state-highlight')) {
                            _hovered.removeClass('ui-corner-all');
                        }
