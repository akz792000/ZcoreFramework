...
public class GenericRepositoryImpl<T, ID extends Serializable> extends GenericJpaRepositoryImpl<T, ID> implements GenericRepository<T, ID> {
	...
	@Override
	public Long count() {
		return RepositoryUtils.count(getEntityManager(), getEntityClass());
	}
	...
	@Override
	public T loadModel(IdField<?> idField) {
		return (T) RepositoryUtils.loadModel(getEntityManager(), getEntityClass(), idField);
	}
	
	@Override
	public Long count(CriteriaCondition criteriaCondition) {
		return RepositoryCriteriaUtils.count(getEntityManager(), getEntityClass(), criteriaCondition);
	}	

	@Override
	public List<T> find(CriteriaCondition criteriaCondition) {
		return RepositoryCriteriaUtils.find(getEntityManager(), getEntityClass(), criteriaCondition);
	}

	@Override
	public int delete(Long id) {
		return RepositoryUtils.delete(getEntityManager(), getEntityClass(), id);
	}
	...
	@Override
	public List<?> loadResultListByTemporalType(String value, Map<String, AbstractMap.SimpleImmutableEntry<Object, Object>> parameters) {
		return RepositoryUtils.loadResultListByTemporalType(getEntityManager(), value, parameters);
	}

	@Override
	public Object loadSingleResultByTemporalType(String value, Map<String, AbstractMap.SimpleImmutableEntry<Object, Object>> parameters) {
    ...
    @Override
    public List<?> loadResultListBySize(String value, Map<String, Object> parameters, int firstResult, int maxResult) {
        return RepositoryUtils.loadResultListBySize(getEntityManager(), value, parameters, firstResult, maxResult);
    }
